...
const WomensFashion = () => {
  ...
  const groupedProducts = useMemo(() => {
    return {
      EthnicWear: filteredProducts.filter(
        (product) => product.category === 'EthnicWear'
      ),
      WesternWear: filteredProducts.filter(
        (product) => product.category === 'WesternWear'
      ),
      FootWear: filteredProducts.filter(
